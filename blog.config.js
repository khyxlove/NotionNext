...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CNGFW', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '中国国安部干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ltkhyx.netlify.app/', // 网站地址
